<div x-data class="ld-filter-control flex flex-col">
    ...
    <div class="flex flex-wrap max-w-48 space-x-1">
        ...
        <button wire:click="removeTextFilter('{{ $index }}', '{{ $key }}')" class="ld-filter-badge m-1 pl-1 flex items-center uppercase tracking-wide bg-gray-300 text-white hover:bg-red-600 rounded-full focus:outline-none text-xs space-x-1">
